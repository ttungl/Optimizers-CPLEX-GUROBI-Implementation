...
% -----
fid1 = fopen('SOLVER_RESULT/cplex_topoA_S40L160_IR_0.05_SUPP1.txt'); % input
fid2 = fopen('SOLVER_RESULT/output_cplex_topoA_S40L160_IR_0.05_SUPP1.txt','wt'); % output
% -----
