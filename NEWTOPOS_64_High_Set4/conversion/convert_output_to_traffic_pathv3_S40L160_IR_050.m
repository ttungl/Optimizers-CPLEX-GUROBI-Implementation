...
fid1 = fopen('SOLVER_RESULT/cplex_topoA_S40L160_IR_0.50_SUPP1.txt');
fid2 = fopen('SOLVER_RESULT/output_cplex_topoA_S40L160_IR_0.50_SUPP1.txt','wt');
% % -----
